...
class ProductProvider with ChangeNotifier {
  ...
  Future loadProductsByShop({String shopId}) async {
    productsByShop = await _productServices.getProductsByShop(id: shopId);
    notifyListeners();
  }
...
//  }
  ...
  void likeDislikeProduct({userId, ProductModel product, bool liked}) {}
}
